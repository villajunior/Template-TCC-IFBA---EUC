...
%\adviser[2]{Nome da Orientadora}
%\coadviser{Nome do/da Orientador/a}
\coadviser[2]{Nome da Orientadora}
...
\begin{document}
    ...
    \include{arq_base/99_figuras} % Gerado Automaticamente
    \include{arq_base/99_tabelas} % Gerado Automaticamente
    ...
    \include{02_revisao_biblio.tex}
    
    \include{03_desenvolv.tex}

    \include{04_conclusao.tex}
